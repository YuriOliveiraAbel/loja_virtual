...
import 'package:loja_virtual/products/category-options/categorys/category_option_tiles.dart';
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      body: FutureBuilder<QuerySnapshot>(
        future: Firestore.instance.collection('product').document(snapshot.documentID)
